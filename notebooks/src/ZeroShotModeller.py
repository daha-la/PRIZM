...
# Import the necessary functions from ZSM_helper_functions.py
from .ZSM_helper_functions import extract_mutant_info, varnumb, hit_rate
            ...
            for sites in site_combinations:
                for mut_ in aa_combinations:
                    ...
                    for site, aa in zip(sites, mut_):
                        ...
                        # Only apply the mutation if the amino acid is different from the original
                        if aa != original_aa:
                            mut_seq[site - 1] = aa

...
MODEL="tranception_noret"
FIRST_INDEX=215  # Adjust as needed
LAST_INDEX=215   # Adjust as needed
...
nohup bash scoring_Tranception_substitutions_no_retrieval.sh $first_index $last_index > "$OUTFILE" 2> "$ERRFILE" &

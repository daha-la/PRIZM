...
# Run the training script with nohup, redirecting both stdout and stderr
nohup bash training_EVE_models.sh $first_index $last_index > "$OUTFILE" 2> "$ERRFILE" &

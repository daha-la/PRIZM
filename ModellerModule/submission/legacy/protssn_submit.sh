...
# YOU NEED TO FIX THE FACT THAT YOU CAN'T ADD NEW MODELS WITHOUT DELETING OLD FILES

# Set the model name and indices
MODEL="protssn"
FIRST_INDEX=1 # Adjust as needed
LAST_INDEX=6   # Adjust as needed
...
nohup bash scoring_ProtSSN_substitutions.sh $first_index $last_index > "$OUTFILE" 2> "$ERRFILE" &

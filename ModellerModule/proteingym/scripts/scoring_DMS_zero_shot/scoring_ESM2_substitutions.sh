...
do
    ...
    export model_checkpoint="$PRIZM_PATH/ModellerModule/checkpoints/esm/esm2_t6_8M_UR50D.pt"
    ...
    start_time=$(date +%s.%N)
    export model_checkpoint="$PRIZM_PATH/ModellerModule/checkpoints/esm/esm2_t12_35M_UR50D.pt"
    ...
    start_time=$(date +%s.%N)
    export model_checkpoint="$PRIZM_PATH/ModellerModule/checkpoints/esm/esm2_t30_150M_UR50D.pt"
    ...
    start_time=$(date +%s.%N)
    export model_checkpoint="$PRIZM_PATH/ModellerModule/checkpoints/esm/esm2_t33_650M_UR50D.pt"
    ...
    start_time=$(date +%s.%N)
    export model_checkpoint="$PRIZM_PATH/ModellerModule/checkpoints/esm/esm2_t36_3B_UR50D.pt"
